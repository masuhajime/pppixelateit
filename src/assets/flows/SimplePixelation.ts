const flows = {
  nodes: [
    ...
    },
    {
      ...
      type: 'KmeansNode',
      position: { x: 1003.1351448059127, y: 535.1167693175516 },
      data: { settings: { number: 12 } },
      width: 177,
      height: 365,
      selected: false,
      positionAbsolute: { x: 1003.1351448059127, y: 535.1167693175516 },
      dragging: false,
    },
    {
    ...
    {
      id: 'node-ImageInputTestNode-174d50a2-0f1a-4717-8193-7531645c5c28',
      type: 'ImageInputTestNode',
      position: { x: 194.5, y: 532 },
      data: { settings: { imageName: 'Apple' } },
      width: 240,
      height: 459,
      selected: false,
      positionAbsolute: { x: 194.5, y: 532 },
      dragging: false,
    },
  ],
  edges: [
    ...
    {
      source: 'node-ImageInputTestNode-174d50a2-0f1a-4717-8193-7531645c5c28',
      sourceHandle: 'image',
      target: 'node-DenoiseNode-80ff5737-805f-4b9d-8cfb-5b2f1ad22b74',
      targetHandle: 'image',
      data: {},
      type: 'custom',
      id: 'reactflow__edge-node-ImageInputTestNode-174d50a2-0f1a-4717-8193-7531645c5c28image-node-DenoiseNode-80ff5737-805f-4b9d-8cfb-5b2f1ad22b74image',
    },
  ],
};
